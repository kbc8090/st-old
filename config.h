 ...
 */
static char *font = "mono:style=Medium:size=14:antialias=true:autohint=false:hinting=true:hintstyle=hintslight:rgba=rgb:lcdfilter=lcddefault:dpi=96";
